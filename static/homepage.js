	function initMap() { //function for creating the location on the map
			var myLatLng = {lat: 30.046362, lng: 31.235017}; //hotel's location

			var map = new google.maps.Map(document.getElementById('map'), {
			zoom: 17,
			center: myLatLng//locating the location on the map
			});

			var marker = new google.maps.Marker({ //creating a marker for the location
			position: myLatLng,
			map: map,
			title: "Nile Hotel"
			});
	...
	//The javascript code following is the code for the gallery!
	...
	objKeyboardMsg.innerHTML = 'press anywher on the imageto close';
